...
export default function CurveCard({ liveApy }: CurveCardProps) {
  ...
  const staticData = {
    ...
    safetyScore: 96,
    risk: 'LOW',
    audits: ['Trail of Bits', 'ChainSecurity', 'Quantstamp'],
    hasInsurance: false,
    hasBugBounty: true,
    verified: true,
    note: 'Stablecoin DEX'
        ...
        <div className="flex justify-between items-start">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="flex gap-2 mb-3">
                ...
                <span className="px-2 py-1 bg-cyan-400/10 rounded-lg text-xs text-cyan-400 border border-cyan-400/20">
                  {staticData.note}
                </span>
              </div>
          ...
          <div className="flex flex-col items-end gap-4 ml-8">
            ...
            <div className="text-right">
              ...
              <div className="text-xs text-gray-500 uppercase tracking-wider">3Pool APY</div>
            </div>
  ...
  return (
    <Link href="/protocols/curve" className="block">
      <div className="bg-[#0F1419] border border-gray-800 rounded-2xl p-6 hover:border-green-400/30 transition-all duration-300 hover:shadow-lg hover:shadow-green-400/5 cursor-pointer">
        ...
        <div className="flex gap-4">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-2">
              <h3 className="text-xl font-bold text-white">Curve Finance</h3>
              {staticData.verified && (
